...
class ShopItemFragment: Fragment() {
    //нельзя передавать аргументы с другого экрана в параметры конструктура т.к при повороте экрана будет вызываться
    ...
    companion object {
        ...
        fun newInstanceChangeFragment(shopItemId: Int): ShopItemFragment{
            return ShopItemFragment().apply {
                arguments = Bundle().apply {
